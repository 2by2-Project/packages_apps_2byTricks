...
import jp.project2by2.settings.utils.DeviceInfoUtil
import jp.project2by2.settings.utils.LottieAnimationUtils
...
class BannerPreferenceController(context: Context) : AbstractPreferenceController(context) {
    ...
    private fun getOSVersion(): String {
        val buildVersion = android.os.SystemProperties.get("ro.2by2.build.version", "")
        val buildVersionCodeName = android.os.SystemProperties.get("ro.2by2.build.version.codename", "")
        return buildVersion + " | " + buildVersionCodeName
    }

    private fun getMaintainerName(): String {
        return mContext.getResources().getString(R.string.maintainer_name)
    }
